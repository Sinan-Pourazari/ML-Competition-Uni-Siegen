...
#drop the id
features = features.drop(['Id','feature_2','feature_21', 'feature_12'], axis=1)
labels = labels.drop(['Id'], axis=1)
predFeatures = predFeatures.drop(['Id', 'feature_2', 'feature_21', 'feature_12'], axis=1)
...
print(return_value)
#save it as file
return_value.to_csv('MLPC8.csv', columns=['Id', 'label'], index=False)