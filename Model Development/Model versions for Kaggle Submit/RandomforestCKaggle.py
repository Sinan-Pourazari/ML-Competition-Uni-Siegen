...
features.drop(['feature_0', 'feature_21','feature_12','feature_5'], axis=1, inplace=True)
testfeatures.drop(['feature_0', 'feature_21', 'feature_12','feature_5'], axis=1, inplace=True)
...
print(return_value)
#save it as file
return_value.to_csv('RDMForC4.csv', columns=['Id', 'label'], index=False)